...
for d in ${DIST}/_astro/*.css ; do
    echo "$d"
    echo `basename $d`
    gzip -9 -c ${d} | aws s3 cp - s3://blog.nikpappas.com/_astro/`basename $d` --acl "public-read" --content-encoding "gzip" --content-type "text/css" --profile "papakos_1"
done
...
#     else
#         echo `basename $d`
#         gzip -9 -c ${d} | aws s3 cp - s3://blog.nikpappas.com/images/`basename $d` --acl "public-read" --content-encoding "gzip" --content-type "image/jpeg" --cache-control "max-age=604800" --profile "papakos_1"
#     fi
# done
...
#     echo "$d"
#     echo `basename $d`
#     gzip -9 -c ${d} | aws s3 cp - s3://blog.nikpappas.com/images/social/`basename $d` --acl "public-read" --content-encoding "gzip" --content-type "image/jpeg" --cache-control "max-age=604800" --profile "papakos_1"
# done
...
#     else
#         echo `basename $d`
#         gzip -9 -c ${d} | aws s3 cp - s3://blog.nikpappas.com/images/`basename $d` --acl "public-read" --content-encoding "gzip" --content-type "image/png" --cache-control "max-age=604800" --profile "papakos_1"
#     fi
# done
...
#     else
#         echo `basename $d`
#         gzip -9 -c ${d} | aws s3 cp - s3://blog.nikpappas.com/images/`basename $d` --acl "public-read" --content-encoding "gzip" --content-type "image/svg+xml" --cache-control "604800" --profile "papakos_1"
#     fi
# done
