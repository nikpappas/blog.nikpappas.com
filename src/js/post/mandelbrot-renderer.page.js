...
async function getContent() {
    const imgSrc = '/images/mandelbrot-renderer.jpg';
    const title = 'Mandelbrot Renderer';
    return createElement(DIV, [
        Banner(imgSrc, title),
        Component(SECTION, [
            GithubRepoLink('https://github.com/nikpappas/mandelbrot-renderer'),
...
async function render() {
    ...
    const head = postHead({
        ...
        description: 'A mandelbrot set renderer. A window to the infinity of the Mandelbrot set.',
        imageUrl: 'https://blog.nikpappas.com/images/social/mandelbrot-renderer.jpg',
        canonical: "https://blog.nikpappas.com/post/mandelbrot-renderer",

    }, `

        <meta property="og:url" content="https://blog.nikpappas.com/post/mandelbrot-renderer" /> 
        <meta name="keywords" content="processing,physics,programming,math,maths,fractals,mandelbrot,set,particle" />
        <meta property="og:image:width" content="1080" />
        <meta property="og:image:height" content="1080" />        

        `)
    await pageRender.render("./intermediate/post/mandelbrot-renderer.html", content, head);
}
